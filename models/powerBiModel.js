...
async function getreport(recordQuery,payload) {
   ...
   if(payload.country === "INDIA" || payload.country === "TURKEY" || payload.country === "VIETNAM_2022" || payload.country === "SRILANKA" || payload.country === "PAKISTAN" || payload.country === "PHILIPPINES" || payload.country === "BURUNDI" || payload.country === "UGANDA"){
