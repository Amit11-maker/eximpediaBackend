...
const dbMongo = {
  ...
  connection_url: `mongodb+srv://mongo-atlas-user-admin:${encodeURIComponent('mongoAtlasExim')}@${process.env.MONGOCLUSTER}/${process.env.MONGODBNAME}?retryWrites=true&w=majority`,
