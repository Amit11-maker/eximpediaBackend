...
const dbMongo = {
  ...
  connection_url: `mongodb+srv://mongo-atlas-user-admin:${encodeURIComponent('mongoAtlasExim')}@eximpedia-dev.dhtuw.mongodb.net/${process.env.MONGODBNAME}?retryWrites=true&w=majority`,
