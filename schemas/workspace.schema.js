...
//     content.taxonomy_id = new ObjectId(data?.taxonomyId) ?? null;
//     content.account_id = new ObjectId(data?.accountId) ?? null;
//     content.user_id = new ObjectId(data?.userId) ?? null;
...
//     content.blob_path = data.blob_path ?? null;
//     content.created_ts = currentTimestamp;
//     content.modified_ts = currentTimestamp;
//     content.workspace_queries = data.workspace_queries;
...
// const workspaceSchemaAdx = {
//     POINTS_CONSUME_TYPE_DEBIT_ADX: POINTS_CONSUME_TYPE_DEBIT,
//     POINTS_CONSUME_TYPE_CREDIT_ADX: POINTS_CONSUME_TYPE_CREDIT,
//     PURCHASE_MODE_RECORDS_SELECTION_ADX: PURCHASE_MODE_RECORDS_SELECTION,
//     PURCHASE_MODE_RECORDS_EXPRESSION_ADX: PURCHASE_MODE_RECORDS_EXPRESSION,
//     IDENTIFIER_SHIPMENT_RECORDS_ADX: IDENTIFIER_SHIPMENT_RECORDS,
//     RESULT_PORTION_TYPE_RECORDS_ADX: RESULT_PORTION_TYPE_RECORDS,
//     RESULT_PORTION_TYPE_SUMMARY_ADX: RESULT_PORTION_TYPE_SUMMARY,
//     RESULT_PORTION_TYPE_FIELD_HEADERS_ADX: RESULT_PORTION_TYPE_FIELD_HEADERS,
//     deriveDataBucket_ADX: deriveDataBucket,
//     deriveWorkspaceBucket_ADX: deriveWorkspaceBucket,
//     buildWorkspace_ADX: buildWorkspace,
//     buildShareWorkspaceData_ADX: buildShareWorkspaceData,
//     buildRecordsPurchase_ADX: buildRecordsPurchase,
//     formulateShipmentRecordsIdentifierAggregationPipeline_ADX: formulateShipmentRecordsIdentifierAggregationPipeline,
//     formulateShipmentRecordsIdentifierAggregationPipelineEngine_ADX: formulateShipmentRecordsIdentifierAggregationPipelineEngine,
//     formulateShipmentTradersAggregationPipeline_ADX: formulateShipmentTradersAggregationPipeline,
//     formulateShipmentRecordsAggregationPipeline_ADX: formulateShipmentRecordsAggregationPipeline,
//     formulateShipmentStatisticsAggregationPipeline_ADX: formulateShipmentStatisticsAggregationPipeline,
// };
...
const createAdxWorkspaceSchema = (payload) => {
  ...
  adxWorkspaceSchema.end_date = payload.end_date ?? "";
  adxWorkspaceSchema.flag_uri = payload.flagUri ?? "";
  adxWorkspaceSchema.created_ts = payload.created_ts ?? new Date();
  adxWorkspaceSchema.modified_ts = payload.modified_ts ?? new Date();
